#ifndef LBM_AN_TESTS_PARAMS_QTRELAX_PARAMS_H_
#define LBM_AN_TESTS_PARAMS_QTRELAX_PARAMS_H_

#include <cmath> // for sqrt

/*
!\brief Custom parameters for QTensor Relaxation integration test
*/
namespace Params {
